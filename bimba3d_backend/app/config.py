...
# DATA_ROOT is the owner for shared, non-project workflow artifacts such as
# prepared Training Data, registered thesis models, and testing summaries.
# Existing project code continues to use DATA_DIR while the backend is migrated.
